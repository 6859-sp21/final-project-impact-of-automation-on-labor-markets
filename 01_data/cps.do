...
quietly infix                   ///
  ...
  byte    pernum       76-77    ///
  double  wtfinl       78-91    ///
  double  cpsidp       92-105   ///
  double  asecwt       106-115  ///
  int     relate       116-119  ///
  byte    age          120-121  ///
  byte    sex          122-122  ///
  int     race         123-125  ///
  byte    marst        126-126  ///
  byte    popstat      127-127  ///
  byte    empstat      128-129  ///
  byte    labforce     130-130  ///
  int     occ          131-134  ///
  int     occ2010      135-138  ///
  int     occ1990      139-141  ///
  int     ind1990      142-144  ///
  ...
  int     ind          148-151  ///
  int     ind1950      152-154  ///
  byte    classwkr     155-156  ///
  double  earnwt       157-166  ///
  byte    lineno       167-168  ///
  double  ftotval      169-178  ///
  double  inctot       179-187  ///
  double  incwage      188-195  ///
  double  incbus       196-203  ///
  double  incfarm      204-211  ///
  byte    migsta1      212-213  ///
  byte    whymove      214-215  ///
  double  hourwage     216-220  ///
  byte    paidhour     221-221  ///
  byte    union        222-222  ///
  double  earnweek     223-230  ///
  int     uhrsworkorg  231-233  ///
  byte    wksworkorg   234-235  ///
  byte    eligorg      236-236  ///
  using `"cps_00001.dat"'
